        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlphabeticCode = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Currencies_AlphabeticCode", x => x.AlphabeticCode);
                    table.UniqueConstraint("AK_Currencies_NumericCode", x => x.NumericCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Foundation = table.Column<int>(type: "integer", nullable: false),
